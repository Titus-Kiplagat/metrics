    ...
    <header className="py-2 bg-[#4269B3]">
      <nav>
        <ul className="flex justify-between items-center">
          ...
          <li className="text-xl font-bold">Stats</li>
          <li className="flex items-center gap-3">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M23.5 0.692611C22.4 1.17561 20.375 2.78161 19 4.26061C16.538 6.90961 16.5 7.20761 16.5 23.8506V40.7516L19.769 44.0206C22.583 46.8346 23.73 47.2896 28 47.2896C32.27 47.2896 33.417 46.8346 36.231 44.0206L39.5 40.7516V23.7896V6.82761L36.407 3.73461C33.105 0.432611 27.239 -0.949389 23.5 0.692611ZM0 37.6076C0 42.0626 3.273 49.8176 6.884 53.9206C10.262 57.7576 16.036 61.2376 22.25 63.1796C23.663 63.6216 24 64.8896 24 69.7586V75.7896H28H32V69.7586C32 64.8916 32.338 63.6196 33.75 63.1736C38.894 61.5466 43.849 58.9686 46.805 56.3796C50.764 52.9136 54.698 45.5316 55.603 39.8726L56.256 35.7896H52.239C48.385 35.7896 48.195 35.9416 47.544 39.5396C46.615 44.6736 42.89 50.0736 38.317 52.9166C35.321 54.7786 33.102 55.2896 28 55.2896C22.898 55.2896 20.679 54.7786 17.683 52.9166C13.11 50.0736 9.385 44.6736 8.456 39.5396C7.809 35.9656 7.595 35.7896 3.889 35.7896C0.796 35.7896 0 36.1616 0 37.6076Z"
                fill="white"
              />
            </svg>
