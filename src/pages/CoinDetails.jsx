...
const CoinDetails = () => {
  ...
  const {
    name, symbol, changePercent24Hr, rank, supply, marketCapUsd, volumeUsd24Hr, priceUsd, vwap24Hr,
  } = coinDetails;

  return (
    <div className="h-screen md:w-1/2 lg:w-1/2 space-y-5 mx-auto p-2">
      <Header />
      <Chart title1={name} title2={symbol} count={`${parseInt(changePercent24Hr, 10).toFixed(4)}%`} />
      <h3 className="px-2 py-5 text-gray-800 font-medium text-2xl">Coin Description</h3>
